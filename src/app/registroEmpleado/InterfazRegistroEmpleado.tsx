...
export function InterfazRegistroEmpleado() {
  ...
  const onSubmit = async (data: EmpleadoFormData) => {
    ...
    try {
      ...
      else setNoice({ type: "error", message: "Error al registrar el empleado" });
      console.error(error);
    }
  };
    ...
    <div className="p-4 max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mb-4">
          ...
          <Input id="apellido" type="text" placeholder="Apellido" {...register("apellido")} />
        ...
        <div className="mb-4">
          ...
          <Input id="tipoDocumento" type="text" placeholder="Tipo de documento" {...register("tipoDocumento")} />
        ...
        <div className="mb-4">
          ...
          <select id="rol" {...register("rol")} className="w-full border px-3 py-2 rounded-md">
